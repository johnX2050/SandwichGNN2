...
print('Log: This brand new model TST 50epo hi 6/9 0238')
...
parser.add_argument('--data',type=str,default='/home/hjl/deep_learning_workspace/data_metrla/1212',help='data path')
