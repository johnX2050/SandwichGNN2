...
from GAGNN_metr_la.model import Model
from GAGNN_metr_la.dataset import trainDataset_metr_la, valDataset_metr_la, testDataset_metr_la
from util import *
import argparse
...
parser.add_argument('--city_num', type=int, default=207, help='')
...
parser.add_argument('--loc_em', type=int, default=4, help='loc embedding')
...
for times in range(args.run_times):
    ...
    for epoch in range(args.epoch):
        ...
        for i, data in enumerate(train_loader):
            ...
            x, y, edge_index, edge_w, loc = data
            outputs = city_model(x, edge_index, edge_w, loc)
        ...
        if epoch % 5 == 0:
            with torch.no_grad():
                ...
                for j, data_val in enumerate(val_loader):
                    ...
                    x_val, y_val, edge_index_val, edge_w_val, loc_val = data_val
                    outputs_val = city_model(x_val, edge_index_val, edge_w_val, loc_val)
